...
import serial_monitor_thread_olimex
...
if __name__ == "__main__":
    ...
    monitor_thread = serial_monitor_thread_olimex.serial_monitor_thread(C_M_QUEUE, M_C_QUEUE, RESULTS_FILENAME, LGTC_NAME,  APP_NAME, APP_PATH)
